...
class Car(Widget):
    ...
    sensor1 = ReferenceListProperty(sensor1_x, sensor1_y) # first sensor vector (detect the forward side of the car)
    ...
    sensor2 = ReferenceListProperty(sensor2_x, sensor2_y) # second sensor vector (detect the left side of the car)
    ...
    sensor3 = ReferenceListProperty(sensor3_x, sensor3_y) # third sensor vector (detect the right side of the car)
